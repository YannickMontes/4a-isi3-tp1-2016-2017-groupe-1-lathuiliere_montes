...
import tp1.graph.node.DoubleLabel;
import tp1.graph.Graph;
import tp1.graph.IDirectedGraph;
import tp1.graph.node.IntegerLabel;
import tp1.graph.node.Node;
import tp1.graph.node.StringLabel;
